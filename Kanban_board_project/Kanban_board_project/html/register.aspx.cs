    ...
    public partial class register : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    picbyte = new byte[this.imgFile.FileBytes.Count()];
                    picbyte = this.imgFile.FileBytes;
                }
                else
                {
                    FileStream fs = new FileStream(Server.MapPath(@"~\html\images\icon_default.jpg"), FileMode.Open, FileAccess.Read);
                    picbyte = new byte[fs.Length];
                    fs.Read(picbyte, 0, System.Convert.ToInt32(fs.Length));
                    fs.Close();
                }

                mg.insertingRecord(nameText, profText, emailText, userText, passText, picbyte);
                mg.sendActivationMessage(emailText, nameText, profText, userText, "erick.horror@gmail.com", "erick20121017ramirez1991horror");
                Session["LblError"] = "Ya hemos enviado el link de activación a su cuenta de correo.";
                Response.Redirect("Dashboard.aspx");
            }
        }
    }
