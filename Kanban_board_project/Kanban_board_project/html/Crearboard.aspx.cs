...
namespace Kanban_board_project.html
{
    public partial class Crearboard : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            conexion.Open();
            string query = "insert into [Kanban].[dbo].[BOARDS] (NOMBRE,FECHAINICIO,COLUMNAS) values(@nombre,@fecha,@columna)";
            ...
            else
            {
                ...
                for (int x = 0; x < 4; x++)
                {
                    query5 += "insert into [Kanban].[dbo].[Columna] ([IDBOARD],[POSICION],[NOMBRE],[WHIPLIMITE]) values(" + idboard + "," + x + ",'" + names[x] + "'," + 0 + ")";
                }
